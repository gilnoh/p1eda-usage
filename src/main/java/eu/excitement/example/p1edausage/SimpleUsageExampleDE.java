 ...
 *
 */
public class SimpleUsageExampleDE {
	
	// NOTE: before running the example --- 
	// please set correct GermaNet path: 
	// modify the following line for your own environment. 
	private static final String germaNetPath = "/Users/tailblues/germanet-8.0/GN_V80_XML";
	 ...
	 */
	public static void trainExampleDE() throws EDAException, LAPException, IOException
	{
		//
		...
		LAPAccess lap = new TreeTaggerDE(); 
		
		// initialize P1EDA instance (that of SimpleWordCoverage), with the two paths 
		P1EDATemplate p1eda = new SimpleWordCoverageDE(germaNetPath); // Put your (configured, instance) P1EDA here... 

		//
		// 2. now we have LAP and EDA. Time to do a training. 
		// 		
    	File rteTrainingXML = new File("src/main/resources/German_dev.xml");  // the source holds RTE3 cases here...
	 ...
	 */
	public static void singlePairTestExampleDE() throws EDAException, LAPException, IOException
	{
		// prepare LAP and P1EDA instance ... 
		LAPAccess lap = new TreeTaggerDE(); 
		P1EDATemplate p1eda = new SimpleWordCoverageDE(germaNetPath);
		...
		JCas aJCas = lap.generateSingleTHPairCAS("1956 gewann Accardo den Genfer Wettbewerb und im Jahre 1958 wurde er der erste Preisträger des Paganini-Wettbewerbs in Genua.", "Accardo gewann den Paganini-Wettbewerb in Genua."); 
	...
	public static void evaluationExampleDE() throws EDAException, LAPException, IOException
	{
    	...
    	File rteTestingXML = new File("src/main/resources/German_test.xml");  // this file holds RTE German test 800 pairs. 
